...
private extension OSlideImproveView {
    func makeConstraints() {
        ...
        NSLayoutConstraint.activate([
            tag2.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 134.scale),
            tag2.widthAnchor.constraint(equalToConstant: 78.scale),
            tag2.heightAnchor.constraint(equalToConstant: 78.scale),
            tag2.topAnchor.constraint(equalTo: topAnchor, constant: ScreenSize.isIphoneXFamily ? 272.scale : 189.scale)
        ])
        
        NSLayoutConstraint.activate([
            tag3.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 168.scale),
            tag3.widthAnchor.constraint(equalToConstant: 78.scale),
            tag3.heightAnchor.constraint(equalToConstant: 78.scale),
            tag3.topAnchor.constraint(equalTo: topAnchor, constant: ScreenSize.isIphoneXFamily ? 349.scale : 266.scale)
        ])
        
        NSLayoutConstraint.activate([
            tag4.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 114.scale),
            tag4.widthAnchor.constraint(equalToConstant: 120.scale),
            tag4.heightAnchor.constraint(equalToConstant: 120.scale),
            tag4.topAnchor.constraint(equalTo: topAnchor, constant: ScreenSize.isIphoneXFamily ? 430.scale : 347.scale)
        ])
        
        NSLayoutConstraint.activate([
            tag5.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 235.scale),
            tag5.widthAnchor.constraint(equalToConstant: 120.scale),
            tag5.heightAnchor.constraint(equalToConstant: 120.scale),
            tag5.topAnchor.constraint(equalTo: topAnchor, constant: ScreenSize.isIphoneXFamily ? 390.scale : 307.scale)
        ])
        
        NSLayoutConstraint.activate([
            tag6.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 213.scale),
            tag6.widthAnchor.constraint(equalToConstant: 111.scale),
            tag6.heightAnchor.constraint(equalToConstant: 111.scale),
            tag6.topAnchor.constraint(equalTo: topAnchor, constant: ScreenSize.isIphoneXFamily ? 516.scale : 433.scale)
        ])
